...
const height = computed(() => {
  const height = props.h ? props.h : "50px";
  return { height };
});
</script>
...
<template>
  <div class="section" :style="height">
    <div class="container">
      <div class="content">
        <img src="/src/assets/worldcup-logo.png" alt="" class="loading">
        <div class="animate">
          <svg
            class="icon" style="
            width: 1em;
            ...
            overflow: hidden;
            margin-right: 0.5em;
          " viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1863"
          >
            <path
